...
<img src="{{ site.url }}{{ site.baseurl }}/images/MatlabProject/Overview.jpg" alt="This is an example of the three images that are chosen to be edited">
...
<img src="{{ site.url }}{{ site.baseurl }}/images/MatlabProject/Action Shot.jpg" alt="">
